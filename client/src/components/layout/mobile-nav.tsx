...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden bg-white dark:bg-card blue-light-filter:bg-card border-t border-gray-200 dark:border-border blue-light-filter:border-border fixed bottom-0 left-0 right-0 z-50 ios-safe-bottom">
